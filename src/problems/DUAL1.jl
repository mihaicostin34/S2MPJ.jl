...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if action == "setup"
        ...
        ig = ig_["obj"]
        pbm.A[ig,iv] += Float64(0.0602220043)
        ig = ig_["c1"]
        ...
        ig = ig_["obj"]
        pbm.A[ig,iv] += Float64(0.0330486024)
        ig = ig_["c1"]
        pbm.A[ig,iv] += Float64(1)
        ...
        ig = ig_["obj"]
        pbm.A[ig,iv] += Float64(0.0442199808)
        ig = ig_["c1"]
        pbm.A[ig,iv] += Float64(1)
        ...
        ig = ig_["obj"]
        pbm.A[ig,iv] += Float64(0.066342261)
        ig = ig_["c1"]
        pbm.A[ig,iv] += Float64(1)
        ...
        ig = ig_["obj"]
        pbm.A[ig,iv] += Float64(0.0488473818)
        ig = ig_["c1"]
        pbm.A[ig,iv] += Float64(1)
        iv,ix_,_ = s2mpj_ii("x40",ix_)
        arrset(pb.xnames,iv,"x40")
        ig = ig_["obj"]
        pbm.A[ig,iv] += Float64(0.0427662316)
        ig = ig_["c1"]
        pbm.A[ig,iv] += Float64(1)
        ...
        ig = ig_["obj"]
        pbm.A[ig,iv] += Float64(0.0498475835)
        ig = ig_["c1"]
        pbm.A[ig,iv] += Float64(1)
        ...
        ig = ig_["obj"]
        pbm.A[ig,iv] += Float64(0.0440972072)
        ig = ig_["c1"]
        pbm.A[ig,iv] += Float64(1)
        iv,ix_,_ = s2mpj_ii("x51",ix_)
        arrset(pb.xnames,iv,"x51")
        ig = ig_["obj"]
        pbm.A[ig,iv] += Float64(0.0378391081)
        ig = ig_["c1"]
        pbm.A[ig,iv] += Float64(1)
        iv,ix_,_ = s2mpj_ii("x52",ix_)
        arrset(pb.xnames,iv,"x52")
        ig = ig_["obj"]
        pbm.A[ig,iv] += Float64(0.0338945825)
        ig = ig_["c1"]
        pbm.A[ig,iv] += Float64(1)
        ...
        ig = ig_["obj"]
        pbm.A[ig,iv] += Float64(0.0344419634)
        ig = ig_["c1"]
        pbm.A[ig,iv] += Float64(1)
        iv,ix_,_ = s2mpj_ii("x55",ix_)
        arrset(pb.xnames,iv,"x55")
        ig = ig_["obj"]
        pbm.A[ig,iv] += Float64(0.0386269386)
        ig = ig_["c1"]
        pbm.A[ig,iv] += Float64(1)
        ...
        ig = ig_["obj"]
        pbm.A[ig,iv] += Float64(0.0449286807)
        ig = ig_["c1"]
        pbm.A[ig,iv] += Float64(1)
        iv,ix_,_ = s2mpj_ii("x59",ix_)
        arrset(pb.xnames,iv,"x59")
        ig = ig_["obj"]
        pbm.A[ig,iv] += Float64(0.0535837558)
        ig = ig_["c1"]
        pbm.A[ig,iv] += Float64(1)
        ...
        ig = ig_["obj"]
        pbm.A[ig,iv] += Float64(0.0417990957)
        ig = ig_["c1"]
        pbm.A[ig,iv] += Float64(1)
        ...
        ig = ig_["obj"]
        pbm.A[ig,iv] += Float64(0.0384920788)
        ig = ig_["c1"]
        pbm.A[ig,iv] += Float64(1)
        ...
        ig = ig_["obj"]
        pbm.A[ig,iv] += Float64(0.0344993296)
        ig = ig_["c1"]
        pbm.A[ig,iv] += Float64(1)
        ...
        ig = ig_["obj"]
        pbm.A[ig,iv] += Float64(0.0458671688)
        ig = ig_["c1"]
        pbm.A[ig,iv] += Float64(1)
        ...
        ig = ig_["obj"]
        pbm.A[ig,iv] += Float64(0.0401984854)
        ig = ig_["c1"]
        pbm.A[ig,iv] += Float64(1)
        iv,ix_,_ = s2mpj_ii("x75",ix_)
        arrset(pb.xnames,iv,"x75")
        ig = ig_["obj"]
        pbm.A[ig,iv] += Float64(0.0428268628)
        ig = ig_["c1"]
        pbm.A[ig,iv] += Float64(1)
        ...
        ig = ig_["obj"]
        pbm.A[ig,iv] += Float64(0.037133664)
        ig = ig_["c1"]
        pbm.A[ig,iv] += Float64(1)
        ...
        ig = ig_["obj"]
        pbm.A[ig,iv] += Float64(0.0381836915)
        ig = ig_["c1"]
        pbm.A[ig,iv] += Float64(1)
        iv,ix_,_ = s2mpj_ii("x83",ix_)
        arrset(pb.xnames,iv,"x83")
        ig = ig_["obj"]
        pbm.A[ig,iv] += Float64(0.0444272761)
        ig = ig_["c1"]
        pbm.A[ig,iv] += Float64(1)
        ...
        ig = ig_["obj"]
        pbm.A[ig,iv] += Float64(0.0416797123)
        ig = ig_["c1"]
        pbm.A[ig,iv] += Float64(1)
        #%%%%%%%%%%%%%% GLOBAL DIMENSIONS %%%%%%%%%%%%%%%%%
        pb.n   = length(ix_)
        ...
        arrset(nlc,length(nlc)+1,ig)
        loaset(pbm.grelw,ig,posel,Float64(62.))
        posel = length(pbm.grelt[ig])+1
        ...
        loaset(pbm.grelw,ig,posel,Float64(2.))
        posel = length(pbm.grelt[ig])+1
        loaset(pbm.grelt,ig,posel,ie_["x6,78"])
        arrset(nlc,length(nlc)+1,ig)
        loaset(pbm.grelw,ig,posel,Float64(-1.))
        posel = length(pbm.grelt[ig])+1
        ...
        loaset(pbm.grelw,ig,posel,Float64(-2.))
        posel = length(pbm.grelt[ig])+1
        loaset(pbm.grelt,ig,posel,ie_["x12,76"])
        arrset(nlc,length(nlc)+1,ig)
        loaset(pbm.grelw,ig,posel,Float64(8.))
        posel = length(pbm.grelt[ig])+1
        ...
        loaset(pbm.grelw,ig,posel,Float64(16.))
        posel = length(pbm.grelt[ig])+1
        loaset(pbm.grelt,ig,posel,ie_["x13,83"])
        arrset(nlc,length(nlc)+1,ig)
        loaset(pbm.grelw,ig,posel,Float64(-7.))
        posel = length(pbm.grelt[ig])+1
        ...
        loaset(pbm.grelw,ig,posel,Float64(-4.))
        posel = length(pbm.grelt[ig])+1
        loaset(pbm.grelt,ig,posel,ie_["x14,77"])
        arrset(nlc,length(nlc)+1,ig)
        loaset(pbm.grelw,ig,posel,Float64(2.))
        posel = length(pbm.grelt[ig])+1
        ...
        loaset(pbm.grelw,ig,posel,Float64(11.))
        posel = length(pbm.grelt[ig])+1
        loaset(pbm.grelt,ig,posel,ie_["x15,17"])
        arrset(nlc,length(nlc)+1,ig)
        loaset(pbm.grelw,ig,posel,Float64(8.))
        posel = length(pbm.grelt[ig])+1
        ...
        loaset(pbm.grelw,ig,posel,Float64(8.))
        posel = length(pbm.grelt[ig])+1
        loaset(pbm.grelt,ig,posel,ie_["x16,82"])
        arrset(nlc,length(nlc)+1,ig)
        loaset(pbm.grelw,ig,posel,Float64(10.))
        posel = length(pbm.grelt[ig])+1
        ...
        loaset(pbm.grelw,ig,posel,Float64(2.))
        posel = length(pbm.grelt[ig])+1
        loaset(pbm.grelt,ig,posel,ie_["x19,82"])
        arrset(nlc,length(nlc)+1,ig)
        loaset(pbm.grelw,ig,posel,Float64(9.))
        posel = length(pbm.grelt[ig])+1
        ...
        loaset(pbm.grelw,ig,posel,Float64(-10.))
        posel = length(pbm.grelt[ig])+1
        loaset(pbm.grelt,ig,posel,ie_["x25,82"])
        arrset(nlc,length(nlc)+1,ig)
        loaset(pbm.grelw,ig,posel,Float64(-15.))
        posel = length(pbm.grelt[ig])+1
        ...
        loaset(pbm.grelw,ig,posel,Float64(-21.))
        posel = length(pbm.grelt[ig])+1
        loaset(pbm.grelt,ig,posel,ie_["x26,77"])
        arrset(nlc,length(nlc)+1,ig)
        loaset(pbm.grelw,ig,posel,Float64(-7.))
        posel = length(pbm.grelt[ig])+1
        ...
        loaset(pbm.grelw,ig,posel,Float64(1.))
        posel = length(pbm.grelt[ig])+1
        loaset(pbm.grelt,ig,posel,ie_["x29,85"])
        arrset(nlc,length(nlc)+1,ig)
        loaset(pbm.grelw,ig,posel,Float64(30.))
        posel = length(pbm.grelt[ig])+1
        ...
        loaset(pbm.grelw,ig,posel,Float64(23.))
        posel = length(pbm.grelt[ig])+1
        loaset(pbm.grelt,ig,posel,ie_["x32,80"])
        arrset(nlc,length(nlc)+1,ig)
        loaset(pbm.grelw,ig,posel,Float64(14.))
        posel = length(pbm.grelt[ig])+1
        ...
        loaset(pbm.grelw,ig,posel,Float64(8.))
        posel = length(pbm.grelt[ig])+1
        loaset(pbm.grelt,ig,posel,ie_["x41,78"])
        arrset(nlc,length(nlc)+1,ig)
        loaset(pbm.grelw,ig,posel,Float64(-9.))
        posel = length(pbm.grelt[ig])+1
        ...
        loaset(pbm.grelw,ig,posel,Float64(-6.))
        posel = length(pbm.grelt[ig])+1
        loaset(pbm.grelt,ig,posel,ie_["x42,79"])
        arrset(nlc,length(nlc)+1,ig)
        loaset(pbm.grelw,ig,posel,Float64(-18.))
        posel = length(pbm.grelt[ig])+1
        ...
        loaset(pbm.grelw,ig,posel,Float64(5.))
        posel = length(pbm.grelt[ig])+1
        loaset(pbm.grelt,ig,posel,ie_["x45,81"])
        arrset(nlc,length(nlc)+1,ig)
        loaset(pbm.grelw,ig,posel,Float64(27.))
        posel = length(pbm.grelt[ig])+1
        ...
        loaset(pbm.grelw,ig,posel,Float64(32.))
        posel = length(pbm.grelt[ig])+1
        loaset(pbm.grelt,ig,posel,ie_["x46,80"])
        arrset(nlc,length(nlc)+1,ig)
        loaset(pbm.grelw,ig,posel,Float64(-2.))
        posel = length(pbm.grelt[ig])+1
        ...
        loaset(pbm.grelw,ig,posel,Float64(8.))
        posel = length(pbm.grelt[ig])+1
        loaset(pbm.grelt,ig,posel,ie_["x47,85"])
        arrset(nlc,length(nlc)+1,ig)
        loaset(pbm.grelw,ig,posel,Float64(-15.))
        posel = length(pbm.grelt[ig])+1
        ...
        loaset(pbm.grelw,ig,posel,Float64(14.))
        posel = length(pbm.grelt[ig])+1
        loaset(pbm.grelt,ig,posel,ie_["x49,70"])
        arrset(nlc,length(nlc)+1,ig)
        loaset(pbm.grelw,ig,posel,Float64(-14.))
        posel = length(pbm.grelt[ig])+1
        ...
        loaset(pbm.grelw,ig,posel,Float64(5.))
        posel = length(pbm.grelt[ig])+1
        loaset(pbm.grelt,ig,posel,ie_["x50,73"])
        arrset(nlc,length(nlc)+1,ig)
        loaset(pbm.grelw,ig,posel,Float64(-1.))
        posel = length(pbm.grelt[ig])+1
        ...
        loaset(pbm.grelw,ig,posel,Float64(1.))
        posel = length(pbm.grelt[ig])+1
        loaset(pbm.grelt,ig,posel,ie_["x52,82"])
        arrset(nlc,length(nlc)+1,ig)
        loaset(pbm.grelw,ig,posel,Float64(16.))
        posel = length(pbm.grelt[ig])+1
        ...
        loaset(pbm.grelw,ig,posel,Float64(-23.))
        posel = length(pbm.grelt[ig])+1
        loaset(pbm.grelt,ig,posel,ie_["x60,80"])
        arrset(nlc,length(nlc)+1,ig)
        loaset(pbm.grelw,ig,posel,Float64(9.))
        posel = length(pbm.grelt[ig])+1
        ...
        loaset(pbm.grelw,ig,posel,Float64(-9.))
        posel = length(pbm.grelt[ig])+1
        loaset(pbm.grelt,ig,posel,ie_["x65,83"])
        arrset(nlc,length(nlc)+1,ig)
        loaset(pbm.grelw,ig,posel,Float64(23.))
        posel = length(pbm.grelt[ig])+1
        ...
        loaset(pbm.grelw,ig,posel,Float64(-17.))
        posel = length(pbm.grelt[ig])+1
        loaset(pbm.grelt,ig,posel,ie_["x68,83"])
        arrset(nlc,length(nlc)+1,ig)
        loaset(pbm.grelw,ig,posel,Float64(5.))
        posel = length(pbm.grelt[ig])+1
        ...
        loaset(pbm.grelw,ig,posel,Float64(9.))
        posel = length(pbm.grelt[ig])+1
        loaset(pbm.grelt,ig,posel,ie_["x72,76"])
        arrset(nlc,length(nlc)+1,ig)
        loaset(pbm.grelw,ig,posel,Float64(-15.))
        posel = length(pbm.grelt[ig])+1
